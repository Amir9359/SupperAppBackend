...
namespace FaraOne.Infraustructor
{
    public class CustomIdentityError:IdentityErrorDescriber
    {
        ...
        public override IdentityError DuplicateUserName(string userName) { return new IdentityError { Code = nameof(DuplicateUserName), Description = $" شماره تلفن '{userName}' به کاربر دیگری اختصاص یافته است." }; }
